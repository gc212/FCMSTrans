...
class MultiScaleConvB(layers.Layer):
    def __init__(self):
        ...
        self.maxpool_21 = layers.MaxPooling2D(pool_size=(3, 3), strides=(1, 1), padding='valid')
        self.conv_22 = layers.Conv2D(256, (5, 5), strides=(1, 1), padding='same', activation='relu')
        self.bn_22 = layers.BatchNormalization()
        self.maxpool_22 = layers.MaxPooling2D(pool_size=(3, 3), strides=(1, 1), padding='valid')
        self.conv_23 = layers.Conv2D(256, (7, 7), strides=(1, 1), padding='same', activation='relu')
        self.bn_23 = layers.BatchNormalization()
        self.maxpool_23 = layers.MaxPooling2D(pool_size=(3, 3), strides=(1, 1), padding='valid')
        ...
        self.maxpool_31 = layers.MaxPooling2D(pool_size=(3, 3), strides=(1, 1), padding='valid')
        self.conv_32 = layers.Conv2D(512, (5, 5), strides=(1, 1), padding='same', activation='relu')
        self.bn_32 = layers.BatchNormalization()
        self.maxpool_32 = layers.MaxPooling2D(pool_size=(3, 3), strides=(1, 1), padding='valid')
        self.conv_33 = layers.Conv2D(512, (7, 7), strides=(1, 1), padding='same', activation='relu')
        self.bn_33 = layers.BatchNormalization()
        self.maxpool_33 = layers.MaxPooling2D(pool_size=(3, 3), strides=(1, 1), padding='valid')
